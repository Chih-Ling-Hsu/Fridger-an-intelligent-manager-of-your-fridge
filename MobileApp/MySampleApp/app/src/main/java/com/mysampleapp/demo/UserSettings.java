...
public class UserSettings {
    ...
    public void setAlarmMode(final Boolean mode){
        this.alarmMode = mode;
    }
    public void setVibrationMode(final Boolean mode){
    ...
    public void loadFromDataset() {
        ...
        final String dataAlarmMode = dataset.get(ALARM_MODE);
        if (dataAlarmMode!=null){
            alarmMode = Boolean.valueOf(dataAlarmMode);
        }
        final String dataVibrationMode = dataset.get(VIBRATION_MODE);
        if (dataVibrationMode!=null){
            vibrationMode = Boolean.valueOf(dataVibrationMode);
        }
    }
    ...
    public void saveToDataset() {
        ...
        dataset.put(ALARM_MODE, String.valueOf(alarmMode));
        dataset.put(VIBRATION_MODE, String.valueOf(vibrationMode));
    }
